...
```
docs/t1136_local_admin_ir.md              ← this file (IR narrative + process)
detections/sigma/t1136_local_admin.yml    ← Sigma rule (Detection 1 & 2)
detections/splunk/t1136_local_admin_v1.spl  ← initial SPL rule
detections/splunk/t1136_local_admin_v2.spl  ← improved version with extra filters
```
